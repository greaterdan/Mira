 ...
 * 
 * NOTE: This requires the server to be run with: node --loader tsx server/index.js
...
try {
  ...
  console.error('[API] Make sure server is run with: node --loader tsx server/index.js');
  throw error;
}
